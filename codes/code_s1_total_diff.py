...
plot_file ="plots\plot_s1_total_diff_ct.png"
...
plot_file ="plots\plot_s1_total_diff_Notf.png"
plt.savefig(plot_file, format='png')
plt.show()
...
plot_file = "plots\plot_s1_total_diff_CR.png"
plt.savefig(plot_file, format='png')
plt.show()
...
plt.legend()
plt.grid()
plot_file = "plots\plot_s1_total_diff_ToTD.png"
plt.savefig(plot_file, format='png')
plt.show()
