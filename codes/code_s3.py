...
simulation_output_file = r"C:\Aterm9\Karshensi_Project\all\tables\simulation_output3.txt"
...
try:
    ...
    output_file = r"C:\Aterm9\Karshensi_Project\all\tables\selected_data_table3.txt"
