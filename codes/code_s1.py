...
try:
    ...
    output_file = r"C:\Aterm9\Karshensi_Project\all\tables\selected_data_table1.txt"
    ...
    for condition_name, condition_set in data_dict.items():
        for section, value in condition_set:
            df_heatmap.at[section, condition_name] = 1 
    ...
    s1_output_file = "plots\plot_s1_result.png" 
    plt.savefig(s1_output_file, format='png')
    plt.show()
